...
<p align="center">
  <a href="https://ameva-workstation-web-core.vercel.app/"><img src="https://img.shields.io/badge/🚀_Live_Demo-Launch_in_Browser-2563eb?style=for-the-badge&logo=vercel&logoColor=white" alt="Live Demo" /></a>
  <a href="https://ameva-workstation-web-core.vercel.app/promo/index.html"><img src="https://img.shields.io/badge/🌐_Official_Showcase-Explore_Features-0ea5e9?style=for-the-badge&logo=googlechrome&logoColor=white" alt="Showcase" /></a>
  <a href="https://github.com/uno-km/AMEVA-Workstation-Web/stargazers"><img src="https://img.shields.io/github/stars/uno-km/AMEVA-Workstation-Web?style=for-the-badge&color=f59e0b&logo=github" alt="Stars" /></a>
  <a href="https://github.com/uno-km/AMEVA-Workstation-Web/network/members"><img src="https://img.shields.io/github/forks/uno-km/AMEVA-Workstation-Web?style=for-the-badge&color=10b981&logo=git" alt="Forks" /></a>
  <a href="https://github.com/uno-km/AMEVA-Workstation-Web/issues"><img src="https://img.shields.io/github/issues/uno-km/AMEVA-Workstation-Web?style=for-the-badge&color=ec4899" alt="Issues" /></a>
  <a href="https://github.com/uno-km/AMEVA-Workstation-Web/blob/main/LICENSE"><img src="https://img.shields.io/badge/License-MIT-8b5cf6?style=for-the-badge" alt="License" /></a>
</p>

<p align="center">
  <img src="https://img.shields.io/badge/WebGPU-Hardware%20Accelerated-38bdf8?style=flat-square&logo=webgpu&logoColor=white" alt="WebGPU" />
  <img src="https://img.shields.io/badge/Local_LLM-Qwen2.5--0.5B%20%7C%201.5B%20%7C%207B-a855f7?style=flat-square&logo=huggingface&logoColor=white" alt="Local LLM" />
  <img src="https://img.shields.io/badge/Privacy-100%25%20Zero--Server%20Leakage-10b981?style=flat-square&logo=shield&logoColor=white" alt="Privacy" />
  <img src="https://img.shields.io/badge/Runtime-React%2019%20%2B%20Vite%208%20%2B%20WASM-f59e0b?style=flat-square&logo=react&logoColor=white" alt="Runtime" />
  <img src="https://img.shields.io/badge/Platform-Web%20%7C%20PWA%20%7C%20Desktop%20(Electron)-6366f1?style=flat-square&logo=electron&logoColor=white" alt="Platform" />
  <img src="https://img.shields.io/badge/TypeScript-Strict%20Type%20Safe-3178c6?style=flat-square&logo=typescript&logoColor=white" alt="TypeScript" />
</p>

<br/>

### 🔗 **[👉 무설치 라이브 웹 앱 즉시 체험하기 (Live Demo)](https://ameva-workstation-web-core.vercel.app/)** • **[🌐 공식 쇼케이스 웹사이트 (Showcase Landing)](https://ameva-workstation-web-core.vercel.app/promo/index.html)**

**외부 서버 데이터 전송 0% & 서버비 0원 — 사용자의 GPU(WebGPU)를 활용한 초고속 온디바이스 로컬 AI 추론, 비디오 타임라인 컷편집, 이미지 AI 배경제거, 오디오 무음 자동삭제, 대용량 PDF 3단계 맵리듀스, 지능형 인터랙티브 지오매핑을 집대성한 올인원 차세대 워크스테이션**

<br/>

[🚀 빠른 시작](#-빠른-시작-가이드-quick-start) • [✨ 16대 핵심 기능 매뉴얼](#-16대-핵심-기능-상세-매뉴얼-complete-user-manual) • [📊 기술 비교표](#-기존-도구-대비-비교-우위-comparison-matrix) • [🏛️ IR 피치덱 & 사업계획서](#-투자-및-엔터프라이즈-리소스-investor--enterprise-hub) • [⌨️ 단축키 & 슬래시 커맨드](#-단축키-및-슬래시-커맨드-치트시트) • [🛡️ 보안 아키텍처](#-엔터프라이즈-보안--아키텍처-security--architecture)

</div>

---

## 💡 왜 AMEVA Workstation인가? (The Vision)

기존의 지식 근로자들은 문서 하나를 완성하기 위해 **노션(Notion), 프리미어(Premiere), 포토샵(Photoshop), 오다시티(Audacity), 구글 맵(Google Maps), ChatGPT, 엑셀(Excel), 카카오톡/슬랙 등 평균 8.3개의 분절된 소프트웨어**를 오가며 엄청난 컨텍스트 스위칭 비용을 낭비하고 있습니다.

더욱이 클라우드 기반 생성형 AI를 사용할 때마다 **기업의 핵심 소스코드와 대외비 문서가 외부 서버로 전송되어 기밀 유출 위기**에 직면하게 되며, 매달 감당하기 힘든 API 토큰 비용이 청구됩니다.

**AMEVA Workstation은 이 모든 문제를 단 하나의 브라우저 탭 안에서 완벽하게 해결합니다.**

1. **🔒 100% 온디바이스 프라이버시 (Zero Data Leakage)**: 모든 AI 추론(Qwen2.5, Whisper, Transformers.js)이 고객의 PC 그래픽카드(WebGPU)에서만 실행되며 외부 서버 전송이 0바이트입니다.
2. **🎬 올인원 멀티미디어 저작 스튜디오**: 마크다운 본문 내에서 비디오 구간 컷팅, 이미지 AI 누끼따기 및 크기조절, 오디오 무음 자동 삭제를 1초 만에 수행합니다.
3. **📑 초고속 문서 인텔리전스**: PDF/DOCX/PPTX/HWPX 대용량 문서를 3초 Fast-Pass 및 3단계 맵리듀스로 챕터별 카드 덱을 생성합니다.
4. **🗺️ 지능형 지오매핑**: OpenStreetMap 기반 다중 핀 꽂기 및 OSRM 추천 경로를 실시간으로 문서에 직렬화 저장합니다.
5. **⚡ 서버비 $0 (Zero Server Dependency)**: 연산 비용을 클라이언트 디바이스가 전담하므로 백엔드 인프라 유지비가 제로($0)에 수렴합니다.
...
├──────────────────────────────┼──────────────────────────────┼────────────────────────────────────┤
│ 🗺️ Geo-Mapping & Navigation  │ 📊 Advanced Block Suite      │ 🛡️ Enterprise Security & Arch     │
...
* **🎥 비디오 타임라인 컷편집 & 8방향 비례 리사이저 (`/video`)**:
  * 외부 영상 편집기를 켤 필요 없이, 에디터 본문에서 재생 막대 좌우 트림 핸들을 조절하여 원하는 시작/종료 시간(`startTime`, `endTime`)을 초 단위로 자릅니다.
  * 8개 방향 모서리 핸들을 잡고 드래그하여 영상의 가로/세로 비율을 자유자재로 리사이징할 수 있으며, 미리보기 모드에서는 조절 바가 숨겨져 깔끔하게 재생됩니다.
* **🖼️ 이미지 갤러리 & Fabric.js 캔버스 스튜디오 (`/image`)**:
  ...
  * **인앱 캔버스 드로잉/필터/텍스트 오버레이**: 크롭, 회전, 밝기/대비 조절, 자유형 브러시 드로잉 지원.
...
* **대용량 3단계 맵리듀스 (Map-Reduce)**: 수십~수백 페이지의 방대한 논문/보고서를 챕터별로 클러스터링 분할(Map) 후 취합(Reduce)하여 **다단계 요약 카드 덱(Document Summaries Deck)**을 생성하며, 원하는 단락 카드만 골라 본문에 1-클릭 블록으로 삽입할 수 있습니다.
...
* **인터랙티브 포스-지향 지식 그래프 (Force-Directed Knowledge Graph)**:
  ...
  * 백그라운드 웹 워커(`graphWorker.ts`) 기반 물리 엔진으로 수천 개 노드도 60fps로 버벅임 없이 매끄럽게 탐색합니다.
...
| :--- | :--- | :--- | :--- |
| **데이터 보안 / 프라이버시** | ❌ 클라우드 서버 전송 (기밀 유출 위험) | ⚠️ 텍스트 로컬 저장 (AI 기능 부재) | **✅ 100% WebGPU 로컬 추론 (외부 전송 0byte)** |
...
| **대용량 문서 분석 (PDF/Doc)**| ⚠️ 페이지 수 제한 및 유료 크레딧 소모 | ❌ 불가 | **✅ 3초 Fast-Pass & 3단계 맵리듀스 덱** |
| **인터랙티브 지오매핑** | ❌ 정적 캡처만 가능 | ⚠️ 단순 지도 뷰어 수준 | **✅ 다중 핀 + OSRM 최적 경로 탐색 직렬화** |
| **엑셀 / 파이썬 WASM** | ❌ 정적 테이블만 지원 | ⚠️ 복잡한 추가 설정 필요 | **✅ FortuneSheet + Pyodide 완전 내장** |

---

## ⌨️ 단축키 및 슬래시 커맨드 치트시트
...
## 🛡️ 엔터프라이즈 보안 & 아키텍처 (Security & Architecture)

```mermaid
graph TD
    Client[Browser / Desktop Sandbox] -->|WebGPU Buffers| WebLLM[Qwen2.5 Local AI Engine]
    Client -->|Web Audio API| AudioCore[Silence Purge & Waveform Core]
    Client -->|OffscreenCanvas| ImageCore[Fabric.js & AI BG Remover]
    Client -->|WASM Worker| PyodideCore[Pyodide Python & NumPy]
    Client -->|CRDT Protocol| YjsSync[P2P / Relay Collaboration]
    Client -->|AES-GCM 256-bit| LocalVFS[Encrypted IndexedDB & .adc Packager]

    style Client fill:#1e293b,stroke:#3b82f6,stroke-width:2px,color:#fff
    style WebLLM fill:#0f172a,stroke:#10b981,stroke-width:2px,color:#fff
    style AudioCore fill:#0f172a,stroke:#0ea5e9,stroke-width:2px,color:#fff
    style ImageCore fill:#0f172a,stroke:#ec4899,stroke-width:2px,color:#fff
    style PyodideCore fill:#0f172a,stroke:#f59e0b,stroke-width:2px,color:#fff
    style LocalVFS fill:#0f172a,stroke:#8b5cf6,stroke-width:2px,color:#fff
```

* **Zero-Knowledge Privacy Protocol**: 모든 미디어 파일, 문서 데이터, 프롬프트는 사용자의 로컬 브라우저 IndexedDB에 저장되며 외부 클라우드로 단 1바이트도 유출되지 않습니다.
* **망분리 기업 완벽 호환**: 인터넷 연결이 차단된 폐쇄망(금융, 군사, 방산, 의료, 정부기관) 환경에서도 100% 모든 기능이 오프라인으로 작동합니다.

---

## 🏛️ 투자 및 엔터프라이즈 리소스 (Investor & Enterprise Hub)
...
## 🏷️ Trending Hashtags & SEO Search Keywords
